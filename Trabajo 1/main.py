...
# modificar ruta del archivo si es necesario
...
def funcionGradiente(t0, t1, alpha, num_iters, m, X, Y):
    ...
    for i in range(num_iters):
        ...
        t0 -= (alpha / m) * sum0
        t1 -= (alpha / m) * sum1
        # calculo el costo llamando a la funcion correspondiente
...
def valoresFinales():
    ...
    print("----------------------------------------------------------")
    print(
        "Valores de theta por gradiente descendente (", num_iters, "iteraciones )", ":"
    )
    print("theta0 =", theta0)
    print("theta1 =", theta1)
    print("y =", theta0, "+", theta1, "* x")
    ...
    print(
        "El beneficio para un área de", habitantes1, "es de: $", beneficio(habitantes1)
    )
    print(
        "El beneficio para un área de",
        habitantes2,
        "es de: $",
        beneficio(habitantes2),
        "\n",
    )
...
# guardo los valores thetas y el costo en un vector temporal
